...
297
Alternative capital treatment for term STC securitizations and short- term STC securitizations meeting the 
STC criteria for capital purposes 
298
Version
Issuance Date
Page Number
...
319
Alternative capital treatment for term securitizations and short-term securitizations meeting the STC criteria 
...
336
27. Illustrative examples for recognition of dilution risk when applying the Securitization Internal 
Ratings-Based Approach (SEC-IRBA) to securitization exposures. 
337
28. Equity investments in funds: illustrative example of the calculation of risk-weighted assets (RWA) 
under the look-through approach (LTA) 
344
29. Equity investments in funds: illustrative example of the calculation of RWA under the mandate- 
based approach (MBA). 
346
...
2. Scope of Application
2.1 This framework applies to all domestic banks both on a consolidated basis, 
...
based capital requirements for credit risk. The first is the standardized 
approach, which is set out in chapters 6 to 9:
i. 
The standardized approach assigns standardized risk weights to 
...
ii. 
To determine the risk weights in the standardized approach for certain 
...
eligible for capital purposes by SAMA. The requirements covering the 
use of external ratings are set out in chapter 8.1 
iii. 
The credit risk mitigation techniques that are permitted to be 
...
approach, which allows banks to use their internal rating systems for credit 
risk. The IRB approach is set out in chapters 10 to 16. Banks must seek 
SAMA’s regulatory approval before they can use the IRB Approach for 
calculation of capital requirements for credit risk, subject to the Bank 
meeting all minimum requirements for the use of IRB Approach, 
...
understanding, at origination and thereafter on a regular basis (at least 
annually), of the risk profile and characteristics of their counterparties. In cases 
where ratings are used, due diligence is necessary to assess the risk of the 
exposure for risk management purposes and whether the risk weight applied is 
appropriate and prudent. The sophistication of the due diligence should be 
appropriate to the size and complexity of banks’ activities. Banks must take 
reasonable and adequate steps to assess the operating and financial 
performance levels and trends through internal credit analysis and/or other 
analytics outsourced to a third party, as appropriate for each counterparty. 
Banks must be able to access information about their counterparties on a 
regular basis to complete due diligence analyses.
...
there is a credit exposure. In evaluating the repayment capacity of the solo 
entity, banks are expected to take into account the support of the group and the 
potential for it to be adversely impacted by problems in the group.
...
Exposures to sovereigns
7.1 
Exposures to sovereigns and their central banks will be risk-weighted based on 
...
100%
7.2 
A 0% risk weight can be applied to banks’ exposures to Saudi sovereign (or 
...
rating.
7.3 
Sovereign exposures to the member countries of Gulf Cooperation Council 
...
Exposures to Public Sector Entities (PSEs)
7.5 
For the purposes of RWA treatment, domestic PSEs in general include 
...
7.6 
Exposures to domestic PSEs will be risk-weighted based on the external rating 
of the Saudi sovereign external rating
Risk weight table for PSEs 
Based on external rating of sovereign 
Table 2 
...
100%
7.7 
Foreign PSEs, including PSEs in GCC countries, shall be assigned a risk weight 
...
owners.
7.9 
A 0% risk weight will be applied to exposures to specified MDBs that are 
recognized by the Basel Committee for Banking Supervision (BCBS) for 
fulfilling the following eligibility criteria:
1. 
very high-quality long-term issuer ratings, i.e. a majority of an MDB’s
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
external ratings must be AAA; 4
2. 
either the shareholder structure comprises a significant proportion of 
...
4. adequate level of capital and liquidity (a case-by-case approach is necessaryin 
...
7.11 For exposures to all other MDBs, banks will assign to their MDB exposures the 
corresponding “base” risk weights determined by the external ratings according 
to Table 3.
Risk weight table for MDB exposures 
Table 3
External 
rating of 
counterparty
...
1. 
External Credit Risk Assessment Approach (ECRA): This approach applies 
to all rated exposures to banks. Banks will apply chapter 8 to determine which 
rating can be used and for which exposures.
2. 
Standardized Credit Risk Assessment Approach (SCRA): This approach is 
...
weight that correspond to the risk weights for short term exposures in Table 4.
...
7.23 Banks will classify all exposures that do not meet the requirements outlined in 
...
1. 
The counterparty bank does not meet the criteria for being classified 
as Grade B with respect to its published minimum regulatory 
requirements, asset out in paragraphs 7.21 and 7.22 or
2. 
Where audited financial statements are required, the external auditor 
...
7.28 To reflect transfer and convertibility risk under the SCRA, a risk-weight floor 
...
i. 
The exposure is not in the local currency of the jurisdiction of 
incorporation of the debtor bank; and
ii. 
For a borrowing booked in a branch of the debtor bank in a foreign 
...
Eligible assets
7.30 
In order to be eligible for the risk weights set out in paragraph 7.34 the 
...
paragraph 7.63 and with a loan-to-value ratio of 60% or lower; or
...
(d) 
the percentage of loans more than 90 days past due; and
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
2. 
The issuer makes the information referred to in point (1) available to the 
...
7.35 Banks must perform due diligence to ensure that the external ratings 
...
bucket higher than the “base” risk weight determined by the external rating. 
...
2. 
Specialized lending exposures, as defined in paragraph 7.41
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
7.40 The definitions of MSMEs shall continue to apply as per SAMA Circular No. 
...
assets;
3. 
The borrowing entity has few or no other material assets or activities, 
...
7.42 Exposures described in paragraph 7.41 will be classified in one of the following 
...
crops), where the loan will be repaid from the proceeds of the sale of 
the commodity and the borrower has no independent capacity to repay 
the loan.
...
7.44 For specialized lending exposures for which an issue-specific external rating is 
not available, and for all specialized lending exposures of banks incorporated 
in jurisdictions that do not allow the use of external ratings for regulatory 
purposes, the following risk weights will apply:
1. 
Object and commodities finance exposures will be risk-weighted at 100%;
2. 
Project finance exposures will be risk-weighted at 130% during the pre- 
...
(a) 
a positive net cash flow that is sufficient to cover any remaining 
...
1. 
The project finance entity is restricted from acting to the detriment of 
the creditors (e.g. by not being able to issue additional debt without the 
consent of existing creditors);
2. 
The project finance entity has sufficient reserve funds or other financial 
arrangements to cover the contingency funding and working capital 
requirements of the project;
3. 
The revenues are availability-based11 or subject to a rate-of-return
...
8. 
Creditors may assume control of the project finance entity in case of 
its default.
Subordinated debt, equity and other capital instruments
...
1. 
An instrument with the same structure as those permitted as 
...
(b) 
The obligation requires (or permits at the issuer’s discretion) 
settlement by issuance of a fixed number of the issuer’s equity 
shares;
(c) 
The obligation requires (or permits at the issuer’s discretion) 
settlement by issuance of a variable number of the issuer’s 
equity shares and (ceteris paribus) any change in the value of the 
...
(d) 
The holder has the option to require that the obligation be settled 
...
decompose the risks for regulatory purposes, with the approval 
of SAMA.
...
7.52 Banks will assign a risk weight of 150% to subordinated debt and capital 
...
2. 
Exposures to MSMEs (as defined in paragraph 7.40) that meet the 
...
1. 
“Regulatory retail” exposures that do not arise from exposures to 
...
transactors (as defined in paragraph 7.58) will be risk weighted at 
75%.
...
“materially dependent on cash flows generated by the 
property”.
...
held by a different bank than the one holding the senior lien mayalso 
...
stability. Banks will be informed accordingly.
...
deposits accounts with the lending bank that meet all requirements 
for on-balance sheet netting and have been unconditionally and 
...
7.69 
A “regulatory residential real estate” exposure is a regulatory real estate
...
above, would predominantly apply to loans to corporates, MSMEs or SPVs, 
but is not restricted to those borrower types. As an example, a loan may be 
...
7.73 As exceptions to the definition contained in paragraph 7.71 above, the following 
...
unit, to an individual who has mortgaged less than two 
properties or housing units;
3. An exposure secured by residential real estate property to associations 
or cooperatives of individuals that are regulated under national 
law and exist with the only purpose of granting its members the 
use of a primary residence in the property securing the loans; 
and
4. An exposure secured by residential real estate property to public 
housing companies and not-for-profit associations regulated 
under national law that exist to serve social purposes and to offer 
tenants long-term housing.
...
7.75 As an alternative to the whole loan approach for regulatory residential real estate 
...
paragraph 7.81) is applied to the residual exposure29. Where there are liens on 
the property that are not held by the bank, the treatment is as follows:
1. 
Where a bank holds the junior lien and there are senior liens not 
held by the bank, to determine the part of the bank’s exposure that 
is eligible for the 20% risk weight, the amount of 55% of the 
property value should be reduced by the amount of the senior liens 
not held by the bank. For example, for a loan of SAR 70,000 to an 
individual secured on a property valued at SAR 100,000, where 
there is also a senior ranking lien of SAR 10,000 held by another 
institution, the bank will apply a risk weight of 20% to SAR 
45,000 (=max (SAR 55,000 – SAR 10,000, 0)) of the 
exposure and, according to paragraph 7.81 a risk weight of 75% to the 
residual exposure of SAR 25,000. (this does not take into account the 
other loan taken by the borrower from the senior lien holder).
2. 
Where liens not held by the bank rank pari passu with the bank’s 
lien, to determine the part of the bank’s exposure that is eligible for 
the 20% risk weight, the amount of 55% of the property value, 
reduced by the amount of more senior liens not held by the bank (if 
any), should be reduced by the product of:
...
the bank’s lien divided by the sum of all pari passu liens. For 
...
Risk weights for regulatory commercial real estate exposures that are not 
materially dependent on cash flows generated by the property
...
materially dependent on cash flows generated by the property
7.79 
For regulatory commercial real estate exposures that are materially dependent
...
7.80 
An “other real estate” exposure is an exposure within the real estate asset
class that is not a regulatory real estate exposure (as defined in paragraph 
7.63 above) and is not a land ADC exposure (as defined in paragraph 7.82 
below). 
7.81 
...
Definition of land acquisition, development and construction exposures 
...
1. 
prudential underwriting standards meet the requirements in paragraph 
...
incomes, salaries). A financial hedge generally includes a legal contract with a 
...
with the character of acceptances).
...
2. Sale and repurchase agreements and asset sales with recourse33 where 
...
treatment for counterparty credit risk must be applied in addition 
to the credit risk charge on the securities or posted collateral, 
where the credit risk of the securities lent or posted as collateral 
remains with the bank. This paragraph does not apply to posted 
collateral related to derivative transactions that is treated in 
accordance with the counterparty credit risk standards.
4. Forward asset purchases, forward deposits and partly paid shares and 
securities,34 which represent commitments with certain drawdown.
...
33 
These items are to be weighted according to the type of asset and not according to the type of
...
7.92 A 10% CCF will be applied to commitments that are unconditionally cancellable 
...
1. 
Any material credit obligation that is past due for more than 90 
days. Overdrafts will be considered as being past due once the 
customer has breached an advised limit or been advised of a limit 
smaller than current outstanding;
2. 
Any material credit obligation is on non-accrued status (e.g. the 
lending bank no longer recognizes accrued interest as income or, 
if recognized, makes an equivalent amount of provisions);
3. 
...
bank taking on any credit exposure to the borrower;
4. 
Any credit obligation is sold at a material credit-related economic loss;
5. 
A distressed restructuring of any credit obligation (i.e. a 
restructuring that may result in a diminished financial obligation 
caused by the material forgiveness, or postponement, of principal, 
interest or (where relevant) fees) is agreed by the bank;
6. 
The borrower’s bankruptcy or a similar order in respect of any of 
the borrower’s credit obligations to the banking group has been 
filed;
7. 
The borrower has sought or has been placed in bankruptcy or 
similar protection where this would avoid or delay repayment of 
any of the credit obligations to the banking group; or
8. 
Any other situation where the bank considers that the borrower is 
unlikely to pay its credit obligations in full without recourse by the 
bank to actions such as realizing security.
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
7.97 For retail exposures, the definition of default can be applied at the level of a 
...
1. 
150% risk weight when specific provisions are less than 20% of 
the outstanding amount of the loan; and
2. 
100% risk weight when specific provisions are equal or greater 
than 20% and less than 50% of the outstanding amount of the 
loan.
3. 
50% risk weight when specific provisions are equal to or greater 
than 50% of the outstanding amount of the loan.
...
Tier1 if they exceed the thresholds set out in that article. A 250% risk weight 
...
7.102 The standard risk weight for all other assets will be 100%, with the exception of 
...
Recognition of external ratings by SAMA
8.1 
The following ECAIs qualify as Eligible ECAI’s in Saudi Arabia,
(1) Standard & Poor's (S&P);
(2) Moody's; and
(3) Fitch.
The recognition process
8.2 
Only credit assessments from credit rating agencies recognized as external credit 
...
economic pressures that may influence the rating. In particular, an ECAI 
...
the composition of the board of directors or the shareholder structure of 
the credit rating agency may be seen as creating a conflict of interest. 
...
the general nature of its compensation arrangements with assessed 
entities; any conflict of interest, the ECAI's compensation arrangements, 
its rating assessment methodologies, including the definition of default, 
...
8.4 
Regarding the disclosure of conflicts of interest referenced in paragraph 8.3(4) 
...
(1) 
The ECAI is being paid to issue a credit rating by the rated entity or by 
the obligor, originator, underwriter, or arranger of the rated obligation;
(2) 
The ECAI is being paid by subscribers with a financial interest that could 
be affected by a credit rating action of the ECAI;
(3) 
The ECAI is being paid by rated entities, obligors, originators, 
...
(4) 
The ECAI is providing a preliminary indication or similar indication of 
...
(5) 
The ECAI has a direct or indirect ownership interest in a rated entity or 
...
(4) above:
(1) 
An ECAI should disclose the general nature of its compensation 
arrangements with rated entities, obligors, lead underwriters, or 
arrangers.
(2) 
When the ECAI receives from a rated entity, obligor, originator, lead 
...
(3) 
An ECAI should disclose in the relevant credit rating report or 
...
8.6 
SAMA will be assigning eligible ECAIs’ ratings to the risk weights available 
under the standardized risk weighting framework, i.e. deciding which rating 
categories correspond to which risk weights.
8.7 
Banks can use the following mapping of ECAIs’ ratings. This mapping will be 
...
the use of ECAIs.
8.9 
Banks must use the global rating scale provided by the ECAIs consistently for all 
...
apply.
(1) 
In circumstances where the borrower has a specific rating for an issued 
...
than that which applies to an unrated exposure) on that specific debt 
may only be applied to the bank’s unrated exposure if this exposure 
ranks in all respects pari passu or senior to the exposure with a rating. 
If not, the external rating cannot be used and the unassessed exposure 
...
(2) 
In circumstances where the borrower has an issuer rating, this rating 
...
rating.
(3) 
In circumstances where the issuer has a specific high-quality rating (one 
...
owed both principal and interest, the rating must fully take into account and 
...
only be used to risk-weight exposures denominated in the domestic currency36.
...
(1) 
The general preferential treatment for short-term exposures applies to 
all exposures to banks of up to three months original maturity when there 
is no specific short-term exposure rating.
(2) 
When there is a short-term rating and such a rating maps into a risk 
weight that is more favorable (i.e. lower) or identical to that derived 
from the general preferential treatment, the short-term rating should be 
used for the specific exposure only. Other short-term exposures would 
benefit from the general preferential treatment.
(3) 
When a specific short-term rating for a short term exposure to a bank 
...
9.4 
The requirements of chapter 19 in Pillar 3 Disclosure Requirements Framework 
...
9.11 In the case of financial collateral, maturity mismatches are not allowed under the 
...
(2) 
P = credit protection amount (e.g. collateral amount, guarantee 
amount) adjusted for any haircuts
(3) 
t = min {T, residual maturity of the credit protection arrangement 
expressed in years}
(4) 
T = min {five years, residual maturity of the exposure expressed in 
years}
...
with the risk weight of the collateral for the collateralized portion of 
the exposure (generally subject to a 20% floor); or
...
9.19 Detailed operational requirements for both the simple approach and 
...
circumstances, a bank must calculate capital requirements as if it were itself 
the principal.
...
Gold.
(3) 
Debt securities that meet the following conditions:
(a) 
Debt securities rated43 by a recognized external credit assessment 
institution (ECAI) where these are either:
(i) 
At least BB– when issued by sovereigns or public sector entities 
...
(4) 
Equities (including convertible bonds) that are included in a main 
index.
(5) 
...
(1) 
Both the exposure and the collateral are cash or a sovereign security or 
...
currency;
(3) 
Either the transaction is overnight or both the exposure and the collateral 
are marked to market daily and are subject to daily remargining;
(4) 
Following a counterparty’s failure to remargin, the time that is required 
...
Business days;
(5) 
The transaction is settled across a settlement system proven for that type 
of transaction;
(6) 
...
either:
(1) 
The collateral is cash on deposit as defined in paragraph 9.34(1); or
(2) 
The collateral is in the form of sovereign/PSE securities eligible for a 0% 
...
9.43 Additionally, where the exposure and collateral are held in different currencies, 
...
(1) 
“Sovereigns” includes: PSEs that are treated as sovereigns by SAMA, as 
well as multilateral development banks receiving a 0% risk weight.
(2) 
“Other issuers” includes: PSEs that are not treated as sovereigns by SAMA.
(3) 
“Securitization exposures” refers to exposures that meet the definition set 
forth in the securitization framework.
(4) 
“Cash in the same currency” refers to eligible cash collateral specified in 
paragraph 9.34(1).
...
9.57 Regarding the minimum holding periods set out in paragraph 9.56, if a netting 
...
(2) 
For netting sets containing one or more trades involving illiquid collateral, 
...
9.58  When the frequency of remargining or revaluation is longer than the minimum, 
...
thesehaircuts must be scaled up or down using the formula below, where:
(1) 
H = haircut
(2) 
...
The comprehensive approach: exemptions under the comprehensive approach 
...
a counterparty-by-counterparty basis if the agreements are legally enforceable 
...
of default; and
(4) 
Be, together with the rights arising from the provisions required in (1) to 
...
9.62 Netting across positions in the banking and trading book may only be recognized 
...
(2) 
Ei is the current value of all cash and securities lent, sold with an
agreement to repurchase or otherwise posted to the counterparty 
under the netting agreement
(3) 
Cj is the current value of all cash and securities borrowed, purchased
...
(6) 
Es is the net current value of each security issuance under the netting
set(always a positive value)
(7) 
Hs is the haircut appropriate to Es as described in tables of
paragraphs 9.49 to 9.50, as applicable
(a) 
Hs has a positive sign if the security is lent, sold with an agreement
to repurchased, or transacted in manner similar to either securities 
lending or a repurchase agreement 
(b) 
Hs has a negative sign if the security is borrowed, purchased with an
agreement to resell, or transacted in a manner similar to either a 
securities borrowing or reverse repurchase agreement
(8) 
N is the number of security issues contained in the netting set 
...
count) 
(9) 
Efx is the absolute value of the net position in each currency fx
...
Collateralized OTC derivatives, exchange traded derivatives and long settlement 
transactions
...
Alpha = 1.4
(2) 
RC = the replacement cost calculated according to paragraphs 6.5 to 
...
the bank:
(1) 
Has a well-founded legal basis for concluding that the netting or 
...
(2) 
Is able at any time to determine those assets and liabilities with the 
...
9.68 When calculating the net exposure described in the paragraph above, assets 
...
(2) 
it is explicitly referenced to specific exposures or a pool of exposures, 
so that the extent of the cover is clearly defined and incontrovertible;
(3) 
other than non-payment by a protection purchaser of money due in 
respect of the credit protection contract it is irrevocable;
(4) 
there is no clause in the contract that would allow the protection 
...
(5) 
it must be unconditional; there should be no clause in the protection 
...
the event that the underlying counterparty fails to make the 
payment(s) due.
...
(1) 
On the qualifying default/non-payment of the counterparty, the bank 
...
grace period that is closely in line with the grace period 
...
(c) 
restructuring47 of the underlying obligation involving forgiveness 
...
(4) 
Credit derivatives allowing for cash settlement are recognized for 
...
buyer must have the right/ability to inform the protection provider of 
...
(8) 
A mismatch between the underlying obligation and the obligation used 
...
(1) 
Sovereign entities48, PSEs, multilateral development banks (MDBs), 
...
9.76 Only credit default swaps and total return swaps that provide credit protection 
...
first-ornth–to-default among the reference names triggers the credit protection 
...
(2) 
Materiality thresholds on payments below which the protection 
provider is exempt from payment in the event of loss are equivalent 
to retained first- loss positions. The portion of the exposure that is 
below a materiality threshold must be assigned a risk weight of 1250% 
by the bank purchasing the credit protection.
...
9.79 Where losses are shared pari passu on a pro rata basis between the bank and the 
...
(3) 
SAMA is satisfied that the cover is robust and that no historical evidence 
...
internal estimates of risk components in determining the capital requirement 
for a given exposure. The risk components include measures of the probability 
of default (PD), loss given default (LGD), the exposure at default (EAD), and 
...
(1) 
The exposure is typically to an entity (often a special purpose vehicle 
(SPV)) that was created specifically to finance and/or operate 
physical assets,
Version
Issuance Date
Page Number
...
broader ongoing operations. In such cases, the value of the commodity serves 
as a risk mitigant rather than as the primary source of repayment.
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
HVCRE includes:
(1) 
Commercial real estate exposures secured by properties of types that 
...
jurisdictions; and
(3) 
Loans financing ADC of any other properties where the source of 
...
loans on the basis of certainty of repayment or borrower equity are, 
...
(1) 
Exposures to individuals – such as revolving credits and lines of credit 
...
(2) 
Where a loan is a residential mortgage (including first and subsequent 
liens, term loans and revolving home equity lines of credit) it is 
eligible for retail treatment regardless of exposure size so long as the 
credit is an exposure to an individual51.
(3) 
Where loans are extended to MSMEs and managed as retail exposures 
...
(1) 
The exposure must be one of a large pool of exposures, which are 
...
(2) 
Where a loan gives rise to a small business exposure below SAR 4 
...
a qualifying revolving retail exposure (QRRE). These criteria must be applied 
at a sub-portfolio level consistent with the bank’s segmentation of its retail 
...
(6) 
The supervisor must concur that treatment as a qualifying revolving 
...
10.28 SAMA may deny the use of the top-down approach for purchased corporate 
...
key elements:
(1) 
Risk components: estimates of risk parameters provided by banks, some 
of which are supervisory estimates.
(2) 
Risk-weight functions: the means by which risk components are 
transformed 
into 
risk-weighted 
assets 
...
foundation and advanced approaches, banks must alwaysuse the risk-weight 
...
(1) 
Exposures to general corporates (i.e. exposures to corporates that are 
...
(2) 
Exposures in the bank asset class in paragraph 10.17, and other 
...
10.33 In making the assessment for the revenue threshold in paragraph 10.32, the 
...
10.38 Banks that meet the requirements for the estimation of PD are able to use the 
...
10.44 For many banks, it may not be practicable for various reasons to implement the 
...
two paragraphs, subject to supervisory approval. Capital requirements for 
such operations will be determined according to the standardized approach, 
SAMA will determine whether a bank should hold more capital under the 
supervisory review process for such positions.
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
10.48 Banks adopting an IRB approach for an asset class are expected to continue to 
...
this chapter:
(1) 
Probability of default (PD) and loss-given-default (LGD) are measured 
as decimals
(2) 
Exposure at default (EAD) is measured as currency (e.g. SAR), except 
...
the EAD.
Risk-weighted assets for corporate, sovereign and bank exposures that are not 
in default
...
11.6 Regarding the formula set out in paragraph 11.5 above, M is the effective 
...
(1) 
Banks that meet the requirements for the estimation of PD will be able 
...
banks that do not meet the requirements for the estimation of PD will 
be required to use the supervisory slotting approach.
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
(2) 
Banks that meet the requirements for the estimation of PD, LGD and 
...
unsecured claims and non-recognized collateral
...
(1) 
E is the current value of the exposure (i.e. cash lent or securities lent 
...
(2) 
ES is the current value of the collateral received after the application
...
specified in paragraphs 12.11 to 12.12. E is capped at the value of E ∙
S
(1+H ).
E
(3) 
EU = E ∙ (1+HE) - Es. The terms EU and ES are only used to calculate
...
(4) 
LGDU is the LGD applicable for an unsecured exposure, as set out in 
paragraphs 12.6 and 12.7.
(5) 
LGD is the LGD applicable to exposures secured by the type of
S
...
S
12.11 Table 16 below specifies the LGD and haircuts applicable in the formula set
out in paragraph 12.10:
Table 16
Type of collateral 
LGDS 
Haircut
...
12.12 When eligible collateral is denominated in a different currency to that of the 
...
collateral, the remaining value of the unsecured exposure (E ) will be reduced
U
by the adjusted value of the collateral (E ) recognized in that step. In line with
S
paragraph 12.10, the total of ES across all collateral types is capped at the
value of E ∙ (1+H ). This results in the formula that follows, where for each
E
collateral type i:
(1) 
LGD is the LGD applicable to that form of collateral (as specified in
S
paragraph 0).
(2) 
E is the current value of the collateral received after the application of
S
the haircut applicable for the type of collateral (H ) (as specified in
c
paragraph 0).
...
12.16 The LGD for each corporate exposure that is used as input into the risk weight 
...
floor, where:
(1) 
LGDU floor and LGDS floor are the floor values for fully unsecured
and fully secured exposures respectively, as specified in the table in 
paragraph 12.10.
(2) 
The other terms are defined as set out in paragraphs 12.10 and 0.
Page Number
Version
Issuance Date
Minimum Capital Requirements for
...
12.18 In cases where a bank has met the conditions to use their own internal estimates 
...
or 12.14, with the exception that the LGD  term would be the bank’s own
U
internal estimate of the unsecured LGD. To adopt this treatment the collateral 
must be eligible under the F-IRB and the bank’s estimate of LGD must not take
U
...
12.22 Under either approach, CRM in the form of guarantees and credit derivatives 
...
(1) 
For the covered portion of the exposure, a risk weight is derived by 
taking:
(a) 
...
(2) 
The bank may replace the LGD of the underlying transaction with the 
...
represents a senior claim on the guarantor this may be reflected by 
using an LGD applicable for senior exposures (see paragraph 12.6) 
instead of an LGD applicable for subordinated exposures.
(3) 
In case the bank applies the standardized approach to direct exposures
Page Number
Version
Issuance Date
Minimum Capital Requirements for
...
to the guarantor it may only recognize the guarantee by applying the 
...
EAD for undrawn revolving commitments58 to extend credit, purchase assets 
or issue credit substitutes provided the exposure is not subject to a CCF of 
100% in the foundation approach (see paragraph 12.33). Standardized approach 
CCFs must be used for all other off-balance sheet items (for example, undrawn 
non- revolving commitments), and must be used where the minimum 
requirements for own estimates of EAD are not met. The EAD for each 
exposure that is not in the sovereign asset class that is used as input into the risk 
weight formula and the calculation of expected loss is subject to a floor that is 
the sum of: (i) the on balance sheet amount; and (ii) 50% of the off balance 
sheet exposure using the applicable CCF in the standardized approach.
Exposures that give rise to counterparty credit risk
...
(EL) amounts for the counterparty credit risk arising from the set of 
transactions covered by the master netting agreement, E* must be used as the 
...
counterparty-by-counterparty basis, both under the condition that the 
collateral is revalued on a daily basis. This holds for the underlying securities 
being different and unrelated to securitizations. The master netting agreement 
must satisfy the criteria set out in paragraphs 9.61 and 9.62 of the 
standardized approach. The VaR models approach is available to banks that 
have received supervisory recognition for an internal market risk model 
according to paragraph 10.2 in The Market Risk Framework. Banks which have 
not received market risk model recognition can separately apply for 
supervisory recognition to use their internal VaR models for the calculation of 
potential price volatility for SFTs, provided the model meets the requirements 
of paragraph 10.2 in The Market Risk Framework. Although the market risk 
standards have changed from a 99% VaR to a 97.5% expected shortfall, the 
VaR models approach to SFTs retains the use of a 99% VaR to calculate the 
counterparty credit risk for SFTs. The VaR model needs to capture risk 
sufficient to pass the back testing and profit and loss attribution tests of 
paragraph 10.4 in The Market Risk Framework. The default risk charge of 
paragraphs 13.18 to 13.39 in The Market Risk Framework is not required in 
the VaR model for SFTs.
...
12.41 The calculation of the exposure E* for banks using their internal model to 
...
12.51 The one-year floor, set out in paragraph 12.46 above, does not apply to certain 
...
following exposures:
(1) 
Short-term self-liquidating trade transactions. Import and export letters 
of credit and similar transactions should be accounted for at their 
actual remaining maturity.
(2) 
Issued as well as confirmed letters of credit that are short term (i.e. have 
...
(1) 
Some capital market-driven transactions and repo-style transactions 
...
(2) 
Some trade finance transactions that are not exempted by paragraph 
12.52.
(3) 
...
overdrafts do not continue more than a short, fixed number of 
business days.
(5) 
...
transaction type set out in paragraph 9.56 of the standardized approach will 
apply to the average. Where more than one transaction type is contained in the 
master netting agreement a floor equal to the highest holding period will apply 
to the average. Further, the notional amount of each transaction should be used 
for weighting maturity.
...
retail exposures. In the case of an exposure that is guaranteed bya sovereign, the 
...
is thegreater of: (i) the one-year PD associated with the internal borrower grade 
...
calculated according to the formula set out in paragraph 12.17. The LGD floor 
for residential mortgages is fixed at 5%, irrespective of the level of collateral 
...
subject toa CCF of 100% in the standardized approach (see paragraph 7.84) and 
...
input in to the risk weight formula and the calculation of expected loss is 
subject to a floor that is the sum of: (i) the on balance sheet amount; and (ii) 
50% of the off balance sheet exposure using the applicable CCF in the 
...
12.65 For retail exposures with uncertain future drawdown such as credit cards, banks 
...
a bank does not reflect conversion factors for undrawn lines in its EAD 
...
securitized, banks must ensure that they continue to hold required capital 
against the undrawn balances associated with the securitized exposures using 
the IRB approach to credit risk for commitments.
...
13.3 Although banks are expected to map their internal ratings to the supervisory 
...
outlined in paragraph 13.7, the corresponding EL risk weight will remain at5% 
...
Demand 
is 
or technology. situation may adequate 
and 
Demand 
is not 
last. stable 
...
conditions 
stressed 
The project is cycle, and may improve soon 
economic 
or only likely to default 
in a 
sectoral 
default under normal 
conditions 
severe 
downturn 
economic 
...
the and are not 
Permitting 
All permits have outstanding but permitting 
considered 
and siting 
been obtained 
their receipt is process 
is routine. 
considered very well defined Significant 
likely 
and they are conditions 
considered 
may 
be 
routine 
...
Weak 
off- 
creditworthiness creditworthiness financial 
taker; 
weak 
(a) If there is of 
off-taker; of 
off-taker; standing 
of termination 
a take-or-pay strong 
strong 
off-taker; 
clauses; tenor 
or fixed-price termination 
termination 
normal 
of 
contract 
off-take 
clauses; tenor of clauses; tenor of termination 
does 
not 
contract: 
contract 
contract exceeds clauses; tenor exceed 
the 
comfortably 
the maturity of of 
contract maturity 
...
financial 
standing
Reserve risks Independently 
Independently 
Proven 
Project relies 
(e.g. natural audited, proven audited, proven reserves can to some extent 
resource 
and 
developed and 
developed supply 
the on 
potential 
development) reserves well in reserves 
in project 
and
Version
Issuance Date
...
demand demand 
for 
the conditions are conditions are 
for 
the project’s type and roughly 
in weak. It is 
project’s type location 
are equilibrium. 
uncertain 
and 
location currently 
in Competitive 
when 
are currently equilibrium. 
The properties are conditions 
in 
number 
of coming on the will improve 
equilibrium. 
competitive 
market 
and and return to 
The 
number properties coming others are in equilibrium. 
of competitive to 
market 
is the planning The project is 
properties 
roughly equal to stages. 
The losing tenants 
coming 
...
lease 
than 
may not be terms are less 
forecasted 
state of the art favourable 
demand 
...
complete 
property’s 
property’s leases property’s leases leases are of 
and 
leases are 
are long-term, 
are medium 
...
range in 
creditworthy 
creditworthiness. tenants that 
creditworthiness. 
tenants and 
The property 
range in 
The property 
their maturity experiences a 
creditworthiness. experiences a 
dates are 
normal level of 
The property 
very high level 
scattered. The tenant turnover 
experiences a 
of tenant 
property has 
upon lease 
...
located 
in located 
in location lacks property’s 
highly 
desirable 
a competitive location, 
desirable 
location that is advantage 
configuration, 
...
is Weaknesses 
condition 
favoured due appropriate in adequate 
in exist in the 
to its design, terms of its terms of its property’s 
configuration, 
design, 
configuration, 
configuration, 
...
conservative 
conservative 
adequate and unrealistic 
and technical and technical contractors 
given 
its 
hazards 
are hazards 
are are ordinarily technical 
limited. 
limited. 
qualified 
hazards. 
...
The 
capacity 
sponsor/develop sponsor/develop sponsor/develop sponsor/devel 
and 
er 
made 
a er 
...
lacks 
willingnes 
substantial cash material 
cash contribution 
capacity 
or 
s 
to contribution to contribution to may 
be willingness to 
support the the construction the construction immaterial 
or support 
the 
property. 
or purchase  of or purchase of non-cash. 
The property 
the 
property. the 
property. sponsor/develop 
The 
The 
er is average to 
sponsor/develop sponsor/develop below average 
er 
has er’s 
financial in 
financial 
...
direct support 
the 
and contingent property in the 
liabilities. 
The event of a cash 
sponsor/develop flow 
shortfall. 
er’s 
properties The 
are 
diversified sponsor/develop 
geographically 
er’s 
properties 
and by property are located in 
type 
several 
geographic 
regions
...
13.15 Table 26 below sets out the supervisory rating grades for object finance 
exposures subject to the supervisory slotting approach.
Table 26 
Strong 
Good 
...
growing, 
stable. 
Some stable,  limited declining, 
strong 
entry entry barriers, entry barriers, vulnerable 
to 
barriers, 
low some 
significant 
...
in changes 
in economic 
technology and technology and technology and outlook, highly 
economic 
economic 
economic 
uncertain 
...
/ Standard 
Aggressive 
ratios (DSCR financial ratios acceptable 
financial ratios financial ratios 
and LTV) 
considering the financial ratios for the asset considering the 
type  of  asset. considering the type 
type of asset 
Very 
robust type  of  asset. 
economic 
Robust project 
assumptions 
economic 
...
Uncertain 
Revenues 
term revenues, short-term 
short-term 
subject 
to 
capable 
of revenues. Loan revenues. Cash strong 
withstanding 
can withstand flows 
are uncertainties; 
severely 
some financial vulnerable 
to even in normal 
stressed 
adversity. 
stresses 
...
Legal 
and Jurisdiction 
is Jurisdiction is Jurisdiction is Poor 
or 
regulatory 
favourable 
to favourable to generally 
unstable legal 
risks 
repossession and repossession 
favourable to and regulatory 
enforcement 
of and 
repossession 
environment. 
...
13.16 Table 27 below sets out the supervisory rating grades for commodities finance 
exposures subject to the supervisory slotting approach.
Table 27
Strong 
Good 
...
Strategic 
Strategic 
Less strategic Non-strategic 
commodity 
commodity 
commodity 
commodity 
1st class buyer Strong buyer 
Acceptable 
Weak buyer 
buyer
Strong 
...
through futures through 
OTC is uncertainty limited 
given 
or 
over-the- instruments. 
about 
the the size and 
counter (OTC) Commodity is possibility 
of depth of the 
instruments. 
not susceptible hedging. 
market. 
No 
Commodity is to damage 
...
Theestimates for PD and LGD (or expected loss, EL) must be calculated for the 
...
(1) 
The purchasing bank will estimate the pool’s one-year EL for default 
...
(2) 
Given the EL estimate for the pool’s default losses, the risk weight for 
...
(1) 
If the purchasing bank is unable to decompose EL into its PD and LGD 
...
(a) 
If the bank can demonstrate that the exposures are exclusively 
seniorclaims to corporate borrowers:
(i) 
An LGD of 40% can be used.
(ii) 
PD will be calculated by dividing the EL using this LGD.
(iii) 
EAD will be calculated as the outstanding amount minus 
...
(iv) 
EAD for a revolving purchase facility is the sum of the 
current amount of receivables purchased plus 40% of 
any undrawn purchase commitments minus KDilution.
(b) 
If the bank cannot demonstrate that the exposures are 
...
(2) 
If the purchasing bank is able to estimate PD in a reliable manner, the 
...
default risk, this estimate must be computed on a stand-alone basis; that 
is, under the assumption of no recourse or other support from the seller 
or third-party guarantors.
(2) 
For the purpose of calculating risk weights for dilution risk, the 
corporate risk-weight function must be used with the following 
settings:
(a) 
...
(c) 
An appropriate maturity treatment applies when determining 
the capital requirement for dilution risk. If a bank can 
demonstrate that the dilution risk is appropriately monitored 
and managed to be resolved within one year, the supervisor 
may allow the bank to apply a one-year maturity.
...
14.11 When collateral or partial guarantees obtained on receivables provide first loss 
...
risk, or both.
(1) 
If the guarantee covers both the pool’s default risk and dilution risk, the 
...
(2) 
If the guarantee covers only default risk or dilution risk, but not both, 
the bank will substitute the risk weight for an exposure to the guarantor 
in place of the pool’s risk weight for the corresponding risk 
component (default or dilution). The capital requirement for the other 
component will then be added.
(3) 
If a guarantee covers only a portion of the default and/or dilution risk, 
...
(excluding the EL amount associated with securitization exposures) to 
...
corporate, sovereign, bank, and retail exposures that are in default, banks 
must use their best estimate of expected loss as defined in paragraph 16.85 
for exposures subject to the advanced approach and for exposures subject to 
the foundation approach banks must use the supervisory LGD. For 
exposures subject to the supervisory slotting criteria EL is calculated as 
described in the chapter on the supervisory slotting approach (paragraphs 
13.8 to 13.12). Securitization exposures do not contribute to the EL amount, 
as set out in in paragraph 18.36.
Version 
Issuance Date 
Page Number
Minimum Capital Requirements for
...
country risk provisions or general provisions) that are attributed to 
exposures treated under the IRB approach. In addition, total eligible 
provisions may include any discounts on defaulted assets. General and 
specific provisions set aside against securitization exposures must not be 
...
SAMA to use an internal allocation method for this purpose.
Treatment of EL and provisions
...
implies. Perceived and measured risk must increase as credit quality declines 
...
as age /occupation).
(2) 
Transaction risk characteristics, including product and/or collateral 
...
rangeof default risk must have enough grades within that range to avoid undue 
...
16.26 To ensure that banks are consistently taking into account available 
...
16.30 A borrower rating must represent the bank’s assessment of the borrower’s 
...
cycle within the respective industry/geographic region. Rating systems 
should be designed in such a way that idiosyncratic or industry-specific 
changes are a driver of migrations from one category to another, and 
business cycle effects may also be a driver.
...
(1) 
The burden is on the bank to satisfy its supervisor that a model or 
...
facilities.
(4) 
When combining model results with human judgement, the judgement 
...
combined.
(5) 
The bank must have procedures for human review of model-based 
...
minimum standards, and must address topics such as portfolio 
...
analyses demonstrating that rating criteria and procedures are likely to result 
in ratings that meaningfully differentiate risk. Rating criteria and procedures 
must be periodically reviewed to determine whether they remain fully 
applicable to the current portfolio and to external conditions. In addition, a 
bank must document a history of major changes in the risk rating process, 
and such documentation must support identification of changes made to the 
risk rating process subsequent to the last supervisory review. The 
organization of rating assignment, including the internal control structure, 
...
16.37 Use of a model obtained from a third-party vendor that claims proprietary 
...
associated with a facility rating as part of the loan approval process. 
Similarly, for retail, each exposure must be assigned to a pool as part of the 
...
16.41 Borrowers and facilities must have their ratings refreshed at least on an annual 
...
Data maintenance
16.45 A bank must collect and store data on key borrower and facility 
characteristics to provide effective support to its internal credit risk 
measurement and management process, to enable the bank to meet the other 
requirements in this document, and to serve as a basis for supervisory 
reporting. These data should be sufficiently detailed to allow retrospective 
re-allocation of obligors and facilities to grades, for example if increasing 
sophistication of the internal rating system suggests that finer segregation of 
portfolios can be achieved. Furthermore, banks must collect and retain data 
on aspects of their internal ratings as required by Pillar 3 Disclosure 
...
complete history of data on the LGD and EAD estimates associated with 
each facility and the key data used to derive the estimate and the 
person/model responsible. Banks must also collect data on the estimated and 
realized LGDs and EADs associated with each defaulted facility. Banks that 
reflect the credit risk mitigating effects of guarantees/credit derivatives 
through LGD must retain data on the LGD of the facility before and after 
evaluation of the effects of the guarantee/credit derivative. Information about 
the components of loss or recovery for each defaulted exposure must be 
retained, such as amounts recovered, source of recovery (e.g. collateral, 
liquidation proceeds and guarantees), time period required for recovery, and 
...
16.48 Banks under the foundation approach which utilize supervisory estimates are 
...
of exposures. For defaulted exposures, banks must retain the data on the 
pools to which the exposure was assigned over the year prior to default and 
the realized outcomes on LGD and EAD.
...
16.51 In addition to the more general tests described above, the bank must perform 
...
16.54 Senior management also must have a good understanding of the rating 
...
supervisory estimates of these parameters. Standards for use of such 
estimates are set out in paragraphs 16.127 to 16.144.
...
and foreseeable conditions. For estimates of LGD and EAD, banks must 
take into account paragraphs 16.82 to 16.98. The number of exposures in the 
...
(1) 
A bank may use data on internal default experience for the estimation 
...
(2) 
Banks may associate or map their internal grades to the scale used by 
...
(3) 
A bank is allowed to use a simple average of default-probability 
...
default calculated based on the average economic loss of all observed 
...
substantially higher than average. For certain types of exposures, loss 
severities may not exhibit such cyclical variability and LGD estimates may 
not differ materially from the long-run default- weighted average. However, 
for other exposures, this cyclical variability in loss severities may be 
important and banks will need to incorporate it into their LGD estimates. For 
this purpose, banks may make reference to the averages of loss severities 
observed during periods of high credit losses, forecasts based on 
appropriately conservative assumptions, or other similar methods. 
Appropriate estimates of LGD during periods of high credit losses might be 
formed using either internal and/or external data. SAMA will continue to 
monitor and encourage the development of appropriate approaches to this 
issue.
...
16.85 Recognizing the principle that realized losses can at times systematically 
...
is five years. The less data a bank has the more conservative it must be in 
its estimation.
Version
Issuance Date
Page Number
...
Banks’ estimates of EAD should reflect the possibility of additional 
drawings by the borrower up to and after the time a default event is 
triggered. Where estimates of EAD differ by facility type, the delineation of 
...
expected between the default frequency and the magnitude of EAD, the 
EAD estimate must incorporate a larger margin of conservatism. Moreover, 
for exposures for which EAD estimates are volatile over the economic cycle, 
the bank must use EAD estimates that are appropriate for an economic 
downturn, if these are more conservative than the long-run average. For 
banks that have been able to develop their own EAD models, this could be 
achieved by considering the cyclical nature, if any, of the drivers of such 
models. Other banks may have sufficient internal data to examine the impact 
of previous recession(s). However, some banks may only have the option of 
making conservative use of external data. Moreover, where a bank bases its 
estimates on alternative measures of central tendency (such as the median or 
a higher percentile estimate) or only on ‘downturn’ data, it should explicitly 
confirm
Version
Issuance Date
Page Number
...
that the basic downturn requirement of the framework is met, ie the bank’s 
...
material information in its derivation of EAD estimates. Across facility 
types, a bank must review its estimates of EAD when material new 
...
principle include use of estimates based or partly based on:
(1) 
SME/midmarket data being applied to large corporate obligors.
(2) 
Data from commitments with ‘small’ unused limit availability being 
applied to facilities with ‘large’ unused limit availability.
(3) 
Data from obligors already identified as problematic at reference date 
...
(4) 
Data that has been affected by changes in obligors’ mix of borrowing 
...
16.94 A well-known feature of the commonly used undrawn limit factor (ULF) 
...
that their EAD estimates are effectively quarantined from the potential 
effects of this region of instability.
(1) 
An acceptable approach could include using an estimation method 
...
(2) 
Common but ineffective approaches to mitigating this issue include 
capping and flooring reference data (e.g. observed CCFs at 100 per 
cent and zero respectively) or omitting observations that are judged to 
be affected.
...
16.96 For transactions that expose banks to counterparty credit risk, estimates of 
...
ability and willingness to honor its obligations. Consistent with the 
...
16.101 In no case can the bank assign the guaranteed exposure an adjusted PD or 
...
portion of the exposure. Alternatively, banks may choose to not recognize 
the effect of guarantees on their exposures.
...
16.106 A bank must have clearly specified criteria for adjusting borrower grades or 
...
and sovereign exposures where own estimates of LGD are used and standards 
...
16.114 A bank purchasing receivables has to justify confidence that current and 
...
following:
(1) 
Legal certainty (see paragraph 16.115).
(2) 
Effectiveness of monitoring systems (see paragraph 16.116)
(3) 
Effectiveness of work-out systems (see paragraph 16.117)
(4) 
...
(2) 
To limit inappropriate draws, the bank should have effective policies 
and procedures for detecting, approving, monitoring, and correcting 
over- advances.
(3) 
The bank should have effective policies and procedures for dealing 
...
reliance on monitoring and control systems to limit credit risk, the bank 
should have an effective internal process for assessing compliance with all 
critical policies and procedures, including:
...
each grade and be able to demonstrate that the realized default rates are 
within the expected range for that grade. Banks using the advanced IRB 
approach must complete such analysis for their estimates of LGDs and 
EADs. Such comparisons must make use of historical data that are over as 
long a period as possible. The methods and data used in such comparisons 
by the bank must be clearly documented by the bank. This analysis and 
...
Changes in methods and data (both data sources and periods covered) must 
...
16.126 Where banks rely on supervisory, rather than internal, estimates of risk 
...
on any cash flow generated by the underlying commercial or residential 
real estate serving as collateral; and
...
affect both the value of the collateral and the performance of the 
borrower.
Version
Issuance Date
Page Number
...
16.129 In light of the generic description above and the definition of corporate 
...
(4) 
Junior liens: In some member countries, eligible collateral will be 
...
(4) 
The bank must appropriately monitor the risk of environmental 
...
(credits given by the borrower to the issuers) and regular financial analysis 
of both the borrower and the issuers of the receivables, especially in the 
case when a small number of large-sized receivables are taken as collateral. 
...
16.141 The bank should have a documented process for collecting receivable 
payments in distressed situations. The requisite facilities for collection 
should be in place, even when the bank normally looks to the borrower for 
collections.
...
(1) 
The bank demonstrates to the satisfaction of SAMA that there are liquid 
...
the market.
(2) 
The bank demonstrates to the satisfaction of SAMA that there are well- 
...
(1) 
With the sole exception of permissible prior claims specified in the 
...
obsolescence;
(2) 
A robust legal framework establishing the lessor’s legal ownership of 
...
and the rate of amortization of the lease payments must not be so 
large as to overstate the credit risk mitigation attributed to the leased 
assets.
...
(1) 
The discounted lease payment stream will receive a risk weight 
...
These are minimum requirements for use of IRB: failure to meet these 
will render banks ineligible to use the relevant IRB approach.
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
Phase-in for standardized approach treatment of equity exposures
17.1 
The risk weight treatment described in paragraph 7.50 will be subject to a 
...
exposures
17.2 
The requirement to use the standardized approach for equity exposures in 
...
(1) 
The risk weight as calculated using the internal ratings-based 
approach that applied to equity exposures prior to 1 January 
2023; and
(2) 
The risk weight set for the linear phase-in arrangement under the 
...
framework
18.1 
Banks must apply the securitization framework for determining regulatory 
...
18.2 
A traditional securitization is a structure where the cash flow from an 
...
18.3 
A synthetic securitization is a structure with at least two different stratified 
...
18.4 
Banks’ exposures to a securitization are hereafter referred to as 
...
18.6 
Underlying instruments in the pool being securitized may include but are not 
...
into the market, or provides liquidity and/or credit enhancements.
18.8 
...
18.9 
A clean-up call is an option that permits the securitization exposures (e.g. 
...
18.14 Implicit support arises when a bank provides support to a securitization in 
...
amount of the assets in the underlying securitized pool.69 While this generally 
...
carrying value – which takes into account purchase discounts and write 
downs/specific provisions the bank took on this securitization exposure – 
...
18.21 An SPE is a corporation, trust or other entity organized for a specific purpose, 
...
18.22 For risk-based capital purposes, tranche maturity (𝑀𝑀𝑇𝑇) is the tranche’s 
remaining effective maturity in years and can be measured at the bank’s 
discretion in either of the following manners. In all cases, 𝑀𝑀𝑇𝑇 will have a 
floor of one year and a cap of five years.
the tranche, as expressed below, where 𝐶𝐶𝐶𝐶𝑡𝑡 denotes the cash flows 
...
T  
∑𝑡𝑡 CFt
(2) On the basis of final legal maturity of the tranche, where 𝑀𝑀𝐿𝐿 is the final
𝑀𝑀𝑇𝑇 = 1 + 80% (𝑀𝑀𝐿𝐿 − 1)
...
the bank would be exposed after a draw has occurred. If those assets are 
...
exposures if it:
(a) 
Is able to repurchase from the transferee the previously 
...
(a) 
Require the originating bank to alter the underlying exposures 
...
(b) Subordinate the bank’s subordinated interest to an even greater
...
(2)  The clean-up call must not be structured to avoid allocating losses to
...
18.32 As a general rule, a bank must, on an ongoing basis, have a comprehensive 
...
its exposure to B under any circumstance, the bank does not need to calculate 
...
18.43 If a bank cannot use the SEC-IRBA, it must use the Securitization External 
...
an SApool may use the Standardized Approach (SEC-SA) as described in 
19.1 to 19.15.
...
Capital charge for mixed pool = d × 𝐾𝐾𝐼𝐼𝐼𝐼𝐼𝐼 + (1− d) × 𝐾𝐾𝑆𝑆𝑆𝑆
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
18.47 Where the bank cannot calculate KIRB on at least 95% of the underlying 
...
the underlying assets, whether or not they are originally IRB.
...
amount of the bank's securitization exposure(s) in the tranche) 
...
Simple, transparent and comparable securitizations: scope of and 
...
18.71 In cases where the criteria refer to underlying assets – including, but not 
...
(b) Homogeneity should be assessed on the basis of common risk
...
deemed to resultin a periodic and well-defined stream of payments 
...
priorto the date of origination;81 and
...
(2) The originator/sponsor of the securitization is expected, where
...
quantitative information including the fraction of notional amounts that 
...
payment dates should be disclosed to investors on a timely basis in 
...
already instructed by one of the transaction parties, e.g. by the arranger or the 
...
18.92 The party or parties with fiduciary responsibility should act on a timely basis 
...
(1) For capital purposes, the terms “initial offering” and “underlying
...
intoaccount any eligible credit risk mitigation, for being assigned a risk 
...
originator or sponsor retains subordinated tranche(s) that form loss 
...
(a) 
Concluded (in its capacity as original lender) the original agreement 
...
interest92 to the ABCP conduit.
(7) 
Sponsor – sponsor of an ABCP conduit. It may also be noted that 
...
and
(8) 
Transaction – An individual transaction in which the ABCP 
...
technically creates resecuritisation.
Criterion A1: Nature of assets (transaction level)
...
(3) Credit claims or receivables included in the securitization should have
...
18.111 The assessment of these conditions should be carried out by the original seller 
...
lenders) intransactions with the conduit demonstrate to it that:
...
course of the seller’s business subject to materially non-deteriorating 
...
on the balance sheet of theseller and not financed by the conduit; and
...
18.119 The sponsor should ensure that the transactions in the conduit effect true 
sale such that the underlying credit claims or receivables:
...
(4) The status and definitions of relevant triggers 
(such as 
...
investorsor otherwise replace itself with another liquidity provider.
...
granularand has sufficiently distributed repayment profiles, the sponsor 
...
these transactions by the conduit; and appropriate legal comfort regarding 
...
transaction and on an ongoing basis, the liability cash flow analysis or 
...
needed to make informed investment decisions. These should be composed 
...
transaction level, orby the sponsor at the conduit level. Ultimately, the 
...
make representations and warranties to investors that:
...
(3) 75% on an individual exposure basis where the exposure is a
...
Standardized approach (SEC-SA)
19.1 
To calculate capital requirements for a securitization exposure to a 
...
exposures not been securitized (𝐾𝐾𝑆𝑆𝑆𝑆); the ratio of delinquent underlying 
exposures to total underlying exposures in the securitization pool (𝑊𝑊); the 
...
maturity, A and D will be the same. 𝐾𝐾𝑆𝑆𝑆𝑆 and 𝑊𝑊 are defined in 19.2 to 19.4 
and 19.6.
19.2 
𝐾𝐾𝑆𝑆𝑆𝑆 is defined as the weighted-average capital charge of the entire portfolio 
...
exposures. 𝐾𝐾𝑆𝑆𝑆𝑆 is expressed as a decimal between zero and one (that is, a 
weighted-average risk weight of 100% means that 𝐾𝐾𝑆𝑆𝑆𝑆 would equal 0.08).
19.3 
For structures involving a special purpose entity (SPE), all of the SPE’s 
...
the risk does not affect its particular securitization exposure or that the risk 
is immaterial – for example, because it has been mitigated.106
19.4 
In the case of funded synthetic securitizations, any proceeds of the issuances 
...
have to be included in the calculation of 𝐾𝐾𝑆𝑆𝑆𝑆 if the default risk of the 
collateral is subject to the tranched loss allocation.107
19.5 
In cases where a bank has set aside a specific provision or has a non- 
refundable purchase price discount on an exposure in the pool, 𝐾𝐾𝑆𝑆𝑆𝑆 must be 
...
19.6 
 The variable 𝑊𝑊 equals the ratio of the sum of the nominal amount of 
delinquent underlying exposures (as defined in paragraph 20.7 below) to the 
nominal amount of underlying exposures.
19.7 
Delinquent underlying exposures are underlying exposures that are 90 days 
...
19.8 
The inputs 𝐾𝐾𝑆𝑆𝑆𝑆 and 𝑊𝑊 are used as inputs to calculate 𝐾𝐾𝐴𝐴, as follows:
𝐾𝐾𝐴𝐴  = (1 − 𝑊𝑊) × 𝐾𝐾𝑆𝑆𝑆𝑆 + 0.5𝑊𝑊
19.9 
In case a bank does not know the delinquency status, as defined above, for 
...
the SEC-SA by adjusting its calculation of 𝐾𝐾𝐴𝐴 as follows:
𝐾𝐾 
𝐸𝐸𝐴𝐴𝐴𝐴𝑠𝑠𝑢𝑢𝑏𝑏𝑏𝑏𝑜𝑜𝑜𝑜𝑜𝑜 1 𝑤𝑤ℎ𝑒𝑒𝑒𝑒𝑒𝑒 𝑊𝑊
𝑠𝑠𝑠𝑠𝑠𝑠𝑠𝑠𝑠𝑠𝑠𝑠𝑠𝑠 1 𝑤𝑤ℎ𝑒𝑒𝑒𝑒𝑒𝑒 𝑊𝑊 
𝑘𝑘𝑘𝑘𝑘𝑘𝑘𝑘𝑘𝑘 
𝐸𝐸𝐴𝐴𝐴𝐴𝑠𝑠𝑢𝑢𝑏𝑏𝑏𝑏𝑜𝑜𝑜𝑜𝑜𝑜 2 𝑤𝑤ℎ𝑒𝑒𝑒𝑒𝑒𝑒 𝑊𝑊 𝑢𝑢𝑢𝑢𝑘𝑘𝑛𝑛𝑛𝑛𝑛𝑛𝑛𝑛
𝑘𝑘𝑛𝑛𝑛𝑛𝑛𝑛𝑛𝑛
𝐴𝐴=[ 
𝐸𝐸𝐸𝐸𝐸𝐸 𝑇𝑇𝑇𝑇𝑇𝑇𝑇𝑇𝑇𝑇 
×𝐾𝐾𝐴𝐴 
...
KSSFA(𝐾𝐾𝐴𝐴) times 12.5.
(3) When A is less than KA and D is greater than KA, the applicable risk
weight is a weighted average of 1250% and 12.5 times KSSFA(𝐾𝐾𝐴𝐴) according
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
tranchein the underlying pool; and
...
External-ratings-based approach (SEC-ERBA)
20.1 
For securitization exposures that are externally rated, or for which an 
...
20.2 
For exposures with short-term ratings, or when an inferred rating based 
...
1250%
20.3 
For exposures with long-term ratings, or when an inferred rating based on a 
...
20.4 
Specifically, for exposures with long-term ratings, risk weights will be 
...
20.5 
The risk weight assigned to a securitization exposure when applying the 
...
20.6 
In the case of market risk hedges such as currency or interest rate swaps, the 
...
tranche.
20.7 
The resulting risk weight is subject to a floor risk weight of 15%. In addition, 
...
Operational requirements for use of external credit assessments
20.8 
The following operational criteria concerning the use of external 
...
Credit Assessment Ratings Provided by Eligible External Credit 
...
assessment, the bank must treat the exposure as if it is unrated and then 
...
Operational requirements for inferred ratings
20.9 
In accordance with the hierarchy of approaches determined in 18.41 to 18.47, 
...
Internal assessment approach (SEC-IAA)
21.1 
In the event that banks have securitization exposures where the IAA 
...
credit enhancementto achieve the same external rating equivalent, 
...
choose only those ECAIs that generally have relatively less 
...
(13) The aggregate estimate of loss on an asset pool that the ABCP
...
21.3 
The exposure amount of the securitization exposure to the ABCP 
...
21.4 
If a bank's internal assessment process is no longer considered adequate, 
...
Internal ratings-based approach (SEC-IRBA)
22.1 
To calculate capital requirements for a securitization exposure to an internal 
...
Definition of KIRB
22.2 
KIRB is the ratio of the following measures, expressed in decimal form (e.g. a 
...
22.3 
Notwithstanding the clarification in paragraphs 18.46 and 18.47 for mixed 
...
22.6 
To calculate KIRB, the treatment for eligible purchased receivables
...
22.7 
22.6 above applies to any securitized exposure, not just purchased 
...
22.8 
SAMA may deny the use of a top-down approach, as defined in 14.8 (1), 
...
22.12 Where default and dilution risk are treated in an aggregate manner (e.g. an 
...
poolwould first be allocated to the securitization exposure. This input, 
...
22.15 The input D represents the threshold at which losses within the underlying 
...
22.17 The supervisory parameter p in the context of the SEC-IRBA is expressed 
as follows, where:
...
22.18 If the underlying IRB pool consists of both retail and wholesale exposures, 
...
22.22 Under the conditions outlined below, banks may employ a simplified method 
...
is the capital requirement per unit of securitization exposure 
...
22.24 The risk weight assigned to a securitization exposure when applying the SEC- 
...
is a weighted average of 1250% and 12.5 times 
...
Alternative capital treatment for term securitizations and short-term 
securitizations meeting the STC criteria for capital purposes
...
Securitization of non-performing loans
23.1 
A non-performing loan securitization (NPL securitization) means a 
...
23.2 
SAMA may provide for a stricter definition of NPL securitizations than that 
...
23.4 
The risk weight applicable to exposures to NPL securitizations according to 
...
23.5 
Where, according to the hierarchy of approaches in 18.41 to 18.47, the bank 
...
pool of exposures.
23.6 
For the purposes of 23.5, NRPPD is the difference between the outstanding 
...
23.7 
An originator or sponsor bank may apply the capital requirement cap 
...
that it is usingthe SEC-IRBA for an exposure to the NPL securitization.
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
that the MBA renders capital requirements no less than the LTA, the risk- 
...
121 If the notional amount of derivatives mentioned in 24.7 is unknown, it will be estimated conservatively using the 
maximum notional amount of derivatives allowed under the mandate.
Version
Issuance Date
Page Number
Minimum Capital Requirements for
...
the notional values of the derivatives in the netting set.122 The risk weight 
...
that the conditions set out in paragraphs 24.1 to 24.12 are met.
Leverage adjustment
...
of the fund, as set out in 24.13, subject to a cap of 1250%.
...
(Avg RW fund) by dividing the total risk-weighted assets by the total assets 
of the fund. 
Using Avg RW fund and taking into account the leverage of a fund (Lvg), 
the risk- weighted assets for a bank’s equity investment in a fund can be 
...
in a consistent manner based on 24.1 to 24.14, as adjusted by 24.16 to  
24.17
Version
Issuance Date
Page Number
...
underwriting criteria), the methods set out in 24.17 below must be 
used.
...
this case, the third party must use the methods set out in 24.17 below, 
with the applicable risk weight set 1.2 times higher than the one that 
would be applicable if the exposure were held directly by the bank.
24.17 In cases when the IRB calculation is not feasible (24.16 (2) above), a third-
party is performing the calculation of risk weights (24.16 (3) above) or 
when the bank is using the MBA the following methods must be used to 
determine the risk weights associated with the fund’s underlying exposures:
...
monitor securities, commodities, and foreign exchange transactions that 
have failed, starting the first day they fail.
...
after the settlement date, see paragraph 25.9 below.
...
the first contractual payment/delivery leg must calculate a capital 
...
been received within five business days. See paragraphs 25.10 to 25.12
Scope of requirements
...
(LGD) in lieu of estimating LGDs so long as they apply it to all failed trade 
...
chapter 7.
25.11 As an alternative to 25.10(1) and 25.10(2) above, when exposures are not 
...
leg has not yet effectively taken place, the bank that has made the first payment 
leg will risk weight the full amount of the value transferred plus replacement 
cost, if any, at 1250%. This treatment will apply until the second 
...
26. Illustrative risk weights calculated under the internal ratings-based (IRB) 
...
Illustrative IRB risk weights for U L 
Table 1 
Asset
class 
Corporate Exposures 
...
126 For the sake of simplicity, the possibility described in paragraph 14.8 of Minimum Capital Requirements for Credit 
...
Attachment and detachment points for each tranche 
Table 2
Attachment point 
Detachment point
Tranche A 
...
Risk-weighted exposure amounts for each tranche 
Table 3
...
reduced to €950,000. When calculating KIRB for Tranche B, the bank can assume 
...
28.1 
Consider a fund that replicates an equity index. Moreover, assume the 
following:
...
28.3 
The total RWA of the fund are therefore USD 251.12 = (0 + 0 +250 + 
1.12).
28.4 
The leverage of a fund under the LTA is calculated as the ratio of 
the fund’s total assets to its total equity, which in this examples is 100/95.
28.5 
Therefore, the RWA for the bank’s equity investment in the fund is 
...
100(95 ∗ 20%)= USD 50.2 
𝑇𝑇𝑇𝑇𝑇𝑇𝑇𝑇𝑇𝑇 𝐴𝐴𝐴𝐴𝐴𝐴𝐴𝐴𝐴𝐴𝐴𝐴𝑓𝑓𝑓𝑓𝑓𝑓𝑓𝑓 
100 
95
𝑅𝑅𝑅𝑅𝑅𝑅𝑓𝑓𝑓𝑓𝑓𝑓𝑓𝑓 
  Leverage  Equity Investment = 251.12
RWA =
Version
Issuance Date
Page Number
...
29. Equity investments in funds: illustrative example of the calculation of RWA 
...
underlying = 100% * USD100 * 250% = USD 250.
...
29.5 The counterparty credit risk exposure in this example, assuming the 
...
29.6 The RWA of the fund is hence obtained by adding RWA on-BS, RWA underlying 
and RWACCR, i.e. USD 503.2 (=250 + 250 + 3.2).
