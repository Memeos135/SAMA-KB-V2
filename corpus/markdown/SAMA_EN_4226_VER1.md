...
الستتسس ‏ تس ‎unica‏ ص ا زا

تحن حي لمح لم د د ا ل

Saudi Arabian Monetary Agency

Banking Supervision Dept.

4) The enclosed Rules shall come into force with immediate effect and banks
...
13.Annexures:
Annex-I: Format for the Reporting of Stress Testing Results
...
i. Stress tests should be designed in such a way that banks should be
...
v. 50653 tests should enable the bank to better understand its risk profile,
...
wee - ‏لمر امامت ست‎ RE REEL EN IS ARAL GL BELLAS LEE ALOT A LALIT LL LL I TS I
meth Mra RE ‏لاا مما ا ا اده الا الا ل ا‎
...
سس سس سس 676 آ6أ6/6ز6ااا سنس ضسممسسسسنساالنسماماللا سوسس ‎ea DONT a NCR EES ERS‏ ماما كالتما ماقا لاا الا اح سا دوه ل ‎ves nsai onic nib ict ease‏
...
Renee eee ‏ابااجاالاالاحأجلاا‎ eeEEOOEOoEEE——EEEEEEOEOEOEOeEeEeeeE—eeE—E—EEEEEEOEeEeEeeeeeeee
an ‏سسب‎ wn
en Nase ate ‏متت‎ ALAN Sen SR AAMT ‏الا ولد عله‎ CA MITES LS NOSE ‏ف تست لقا‎ AN DSA SS TEM NENT ENTREES ‏موي ان لم‎
‏ممم ااام ناملالا اص‎
‏احا ا ا ا‎
...
ميتملا ري ملب تابي لوا ا بابي لامي لين لبت ام لا لا ل رتالب لاوق ول هام 2 نامرع بي وج ب ا د ا ل ل ان ان ل ‎aera aa acta aaa aaa aaa aaa‏
...
decision of scenarios selection should be taken carefully after taking into account
...
111. Counterparty credit risk which may be reflected in the relatively high
...
The above examples are for illustration only and the banks are expected to develop
...
ii. Moderate Level Shocks: These represent medium level shocks, the
...
tisks. Banks should also capture the effect of reputational risk as well as integrate
...
Rating Based (IRB) Approach of Basel-II. Furthermore, they may use a
...
LEELA EARLE AAD LEE AI BLLELLEAARSEER SCN SE DBE ALS NEALE DL BASE A NC ‏مس ا لحم‎ BRN IN BREA
...
mix of their credit portfolio. Furthermore, they should take into account the
...
assess the impact of identified risk factors on the quality of credit
portfolio;
...
relationships across the range of maturities (yield curve risk); and (iv) interest-
...
cee ten ‏ماما ا ا افا ااانا‎ aaa
EEE TT ‏بال تمان لهو وا تاه ارم لورا لم041 كناد‎

on both assets and liabilities side including off-balance sheet
exposures;

ii. Basis Risk: This scenario would involve assessing the impact on
profitability due to unfavorable differential changes in key market
rates;

iti. Yield Curve Risk: This scenario may assess the impact on profitability
...
i. Appreciation in Exchange Rates: Banks may develop stress scenarios
...
ii. Depreciation in Exchange Rates: Banks may develop stress scenarios
...
i. Fall in stock market Indices: Banks may develop stress scenarios to
assess the impact of certain assumed levels of decline in the stock
market indices on their earnings and capital;

ui. Drop in value of portfolio: If the bank holds an equity portfolio highly
...
iii. Drop in Collateral Coverage: Banks active in margin lending may
...
ech stains i aah ik ‏ا لاف‎ i NS SN ‏متموا ا ملذت»‎

EEE IEE IOOGSSSCC CN LERLRCLSLSCRE LLL LEE LIE ALA ‏سات لم مانا‎ EALE LN LEAL ALLA ANA hae Sc titties
...
sources of funding and estimate the impact of such changes on the
funding cost and profitability of the bank;

il, Significant Maturity Mismatches: Such scenarios may involve
...
BC’ ERA PLL LEP LLEASSEE SEE NAA LLL AE ASE ‏ا ساقي‎ Cn Nt ‏امسا دقام كي‎ tO LAL AA NR a hii tOe EN omit

Banks should develop stress scenarios for operational risk stress tests based on the
...
i. assets quality — increase/decrease in classified assets particularly loans
...
‎capital adequacy — measured in terms of the changes in total amount‏ .للا
...
be submitted to SAMA on annual basis. This requirement would not be applicable
to branches of foreign banks as they are not required to prepare ICAAP.
...
tisk, revisiting of business growth plans or growth plans in a particular
...
IEE EE EEE IITSSSSSSSSSSSSSES OE ALAA NADER ALLE ALLEL ALD LANES APPAR A AD ba Pb bs its ‏لحان‎ teen innate wit

vi. Banks should estimate the impact of identified actions on their
...
vii. The results of stress tests should be reflected in the policies and risk
tolerance limits set by the management;

viii. Banks may also set out the minimum thresholds or triggers (e.g. the
...
i. Statement providing Data for conducting Top-Down stress tests by the
Agency as per the prescribed format (the format to be separately
communicated electronically);

ii. Statement providing results of the Bottom-up stress tests conducted by
banks on the format attached as Annexure-I to these Rules;

iii. Half-yearly / yearly financial statements prepared by banks on their
standard formats.
...
لزلز يي تك لسكب نع بساك ب ب سج ل ا ةزات جع يب

## Page 34

ام سيت سسا سمت ام الا ااانا ااا اانه اناا انان ااا ا ا أن ااانا

December, within three months of the end of every half-year. The first such return
...
i Use of Bottom-up Stress Testing Results: Banks are required to submit
...
ii. Requiring Banks to Run Specified Scenarios: SAMA may require banks to
tun the specified scenarios on their portfolios to assess the plausibility of
...
iii. System-wide Stress Testing: SAMA may conduct its own stress tests based
...
ا ول بز زب سك << ج>>> جب بج >> جب <> > اجاج > جح > اج اجا با ماجحا ‎a CIO TTT I‏ ا ع ‎TTT ST‏ جم بم ها

## Page 37

rai aaah eam ‏سس سس سات ححا جنا ااا ااا‎ tseli i athena
...
HA hi sn ts ‏ااانا لان لاا‎ ae ‏ممم حت‎ AA ninth sto
...
Q.3: Will SAMA provide a covariance matrix of the risk factors and
...
للد كت مستا ‎ti‏ ام ‎ELE LBL AEP NSD a‏ ين اليل الل متم ل ل ل

stress tests to SAMA on half-yearly basis as per the format attached with the
...
Ans.: The format for providing data under Para 10(i) of the Rules will
...
Q.9: Can the branches of foreign banks rely on_ their Group's
